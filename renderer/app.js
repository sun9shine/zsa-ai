...
- Respond in the same language the user uses`;
  ...
  async downloadAsZip() {
    try {
      ...
      // Extract CSS and JS from the HTML to separate files
      const code = this.currentCode;
      ...
      // Create clean HTML with linked CSS/JS
      let cleanHtml = code;
      if (cssContent) {
      ...
      // Also include the full single-file version
      zip.file('index-full.html', code);

      // Add a README
      zip.file('README.txt', `Generated by ZSA AI - Chat to Code\nDate: ${new Date().toLocaleString()}\n\nFiles:\n- index.html: Main HTML (links to external CSS/JS)\n- styles.css: Stylesheet\n- script.js: JavaScript\n- index-full.html: Complete single-file version\n\nOpen index.html in your browser to view the project.`);
